"""Reusable gpredict faketime pass helpers (scenario-2 · ENIGMA-1 uplink).
...
def find_pass(qth_path, tle_path, min_alt=15.0, max_alt=45.0, search=40):
    ...
    (so the satellite crosses NEAR the station, not straight overhead — a
    grazing "just skimming past" look). Returns (aos_unix, los_unix, max_alt_deg).
