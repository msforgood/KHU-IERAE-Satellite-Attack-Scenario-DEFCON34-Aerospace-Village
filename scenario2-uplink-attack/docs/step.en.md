...
Command Builder     ─▶     attack.cf32          ─▶    Aim/align virtual         ─▶   VSA transmits IQ          ─▶   victim ground station
web screen                 (IQ signal file)           satellite via                  (uplink launch)                dashboard alert
                                                      gpredict + VSA                                                (web screen)
...
| **③ Satellite Aiming** | gpredict + OpenVSA(VSA)                    | 🛰️ **antenna stepper motor** left↔right sweep |
